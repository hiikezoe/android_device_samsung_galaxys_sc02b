...
# GPS config
PRODUCT_COPY_FILES += \
  device/samsung/galaxys_sc02b/gps.xml:system/vendor/etc/gps.xml \
  device/samsung/galaxys_sc02b/gps.conf:system/etc/gps.conf

$(call inherit-product, device/samsung/galaxys_sc02b/device_base.mk)

# See comment at the top of this file. This is where the other
# half of the device-specific product definition file takes care
# of the aspects that require proprietary drivers that aren't
# commonly available
$(call inherit-product-if-exists, vendor/samsung/galaxys_sc02b/device-vendor.mk)
